    ...
    public static CodeWriter WriteType(this CodeWriter writer, ITypeBuilder builder) =>
        writer
            ...
            .WriteCodeBlock(builder, static (builder, nw) => nw
                ...
                .WhenOfType<ClassBuilder>(builder, static (cb, w) => w
                    .When(cb.Modifier == ClassModifier.Abstract, static w => w.Append("abstract "))
                    .When(cb.Modifier == ClassModifier.Sealed, static w => w.Append("sealed "))
                )
                ...
                .WhenOfType<StatefulTypeBuilder>(builder, static (s, w) => w
                    ...
                    .WriteBaseTypes(s is ClassBuilder {BaseType: {} @base} ? s.Interfaces.Prepend(@base) : s.Interfaces)
